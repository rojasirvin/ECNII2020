...
$$\frac{1}{2}\frac{\partial \mathcal{L}_N(\theta)}{\partial \theta }=\frac{1}{2}\sum_i\frac{\partial \ln f(y_i|x_i,\theta)}{\partial \theta}=0$$
...
- Supingamos:
  ...
  1. La matriz $A_0=p\lim\frac{1}{N}\frac{\partial^2\mathcal{L}_N(\theta)}{\partial \theta \partial\theta'}\Bigg|_{\theta_0}=0$ existe y es no singular
