...
# Ejemplo: estudio del progreso académico

.pull-left[
- Vieja econometría

  - Se busca modelar una medida, quizás basada en resultados de un examen
...
- Nueva econometría
  ...
  - Por ejemplo, ¿cómo afecta el tipo de escuela? Pública vs privada
...
- Econometría de este curso
  ...
  - Controles: nos permiten hacer comparaciones dentro de grupos
  
  - Nos enfocamos en unas cuantas (con frecuencia una) variables de interés manteniendo el resto constante
